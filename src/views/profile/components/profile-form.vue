    ...
    <ion-list v-if="user">
        <ion-item lines="none">
            <ion-item style="margin: 0;padding: 0;" lines="none">
                ...
                <ion-input :value="user.name" :disabled="!props.edit" style="width:60%"></ion-input>
            </ion-item>
            <ion-item style="margin: 0;padding: 0;" lines="none">
                <label style="width:40%">性别:</label>
                <ion-input :value="user.sex" :disabled="!props.edit" style="width:60%"></ion-input>
            </ion-item>
        </ion-item>
        <ion-item lines="none">
            <ion-item style="margin: 0;padding: 0;" lines="none">
                <label style="width:40%">班级:</label>
                <ion-input :value="user.class" :disabled="!props.edit" style="width:60%"></ion-input>
            </ion-item>
            <ion-item style="margin: 0;padding: 0;" lines="none">
                <label style="width:40%">寝室:</label>
                <ion-input :value="user.room" :disabled="!props.edit" style="width:60%"></ion-input>
            </ion-item>
        </ion-item>
        <ion-item lines="none">
            <label>学号:</label>
        ...
        <ion-button expand="block" color="primary" @click="changeMode" v-if="!props.edit">编辑</ion-button>
        <ion-button expand="block" color="primary" @click="changeMode" v-else>保存</ion-button>
    </ion-list>
</template>
